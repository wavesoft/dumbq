...
/cvmfs/sft.cern.ch/lcg/external/experimental/cernvm-copilot/usr/bin/copilot-config --user-data 2>&1 >/dev/null 

# Select configuration and start co-pilot
export COPILOT_CONFIG=${BOOTSTRAP_DIR}/etc/copilot
/bin/env PATH=$PATH LANG=C  perl -I /cvmfs/sft.cern.ch/lcg/external/experimental/cernvm-copilot/lib/perl5/site_perl/5.8.8/ /cvmfs/sft.cern.ch/lcg/external/experimental/cernvm-copilot/usr/bin/copilot-agent
